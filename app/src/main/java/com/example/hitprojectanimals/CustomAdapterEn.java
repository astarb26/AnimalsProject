...
public class CustomAdapterEn extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    Context context;
    private ArrayList<DataModel> dataSet;


    public CustomAdapterEn(ArrayList<DataModel> dataSet, BlankFragmentEn blankFragmentOne) {
    ...
    public void onBindViewHolder(@NonNull CustomAdapter.MyViewHolder viewHolder, int listPosition) {
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                Navigation.findNavController(view).navigate(R.id.action_blankFragmentEn_to_blankFragmentEnTwo,bundle);
            }
        });
